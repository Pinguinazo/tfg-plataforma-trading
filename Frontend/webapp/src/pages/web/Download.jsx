      ...
      <div className="max-w-3xl w-full bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-10 md:p-16 rounded-3xl shadow-2xl relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="/TradingPulse-Desktop-v2.exe" 
              download="TradingPulse-Desktop-v2.exe"
            ...
            <a 
              href="/TradingPulse-Desktop-Linux.tar.gz" 
              download="TradingPulse-Desktop-Linux.tar.gz"
            ...
            <a 
              href="/TradingPulse.apk"
              download="TradingPulse.apk"
